        ...
        with st.spinner("⏳ 마스터 정산 정보의 월청구비용 및 PayBack(VAT포함) 항목을 계산하여 매핑 중입니다..."):
            try:
                ...
                for agency, row_list in agency_rows_map.items():
                    ...
                    cell_n = ws_prev[f'N{first_r}']
                    cell_n.value = total_pb
                    cell_n.number_format = accounting_format
                ...
                # 컬럼 너비 보정
                col_widths = {
                    'A': 3.5, 'B': 30.0, 'C': 30.0, 'D': 13.0, 'E': 9.0,
                    'F': 12.0, 'G': 13.0, 'H': 13.0, 'I': 32.0, 'J': 13.0,
